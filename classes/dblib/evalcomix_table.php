...
require_once(DIRROOT . '/classes/dblib/evalcomix_field.php');
require_once(DIRROOT . '/classes/dblib/evalcomix_key.php');
require_once(DIRROOT . '/classes/dblib/evalcomix_dbobject.php');
    ...
    public static function get_type($type) {
        ...
        switch (strtolower($type)) {
			...
			case 'integer':
                ...
                break;
			case 'tinyint':
				$result = EVALCOMIX_TYPE_SMALLINT;
                break;
			case 'smallint':
				$result = EVALCOMIX_TYPE_SMALLINT;
                break;
			...
			case 'timestamp':
                ...
                break;
			case 'primary':
                $result = EVALCOMIX_KEY_PRIMARY;
                break;
			case 'foreign':
                $result = EVALCOMIX_KEY_FOREIGN;
                break;
        }
