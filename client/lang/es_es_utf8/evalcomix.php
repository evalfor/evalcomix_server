<?php
	...
	$string['numdimensions'] = 'NÂº Dimensiones:';
	$string['numvalues'] = 'NÂº de Valores:';
...
//ALERTAS
	$string['save'] = 'El instrumento se ha guardado satisfactoriamente';
       $string['ADimension'] = 'Este campo no puede estar vacÃ­o. \"NÂº de Dimensiones\" debe ser un nÃºmero mayor que 0 y \"ValoraciÃ³n Global\" un nÃºmero mayor o igual que 2';
	$string['ATotal'] = 'Este campo no puede estar vacÃ­o. \"NÂº de Valores\" debe ser un nÃºmero mayor o igual que 2';
	$string['ASubdimension'] = 'Este campo no puede estar vacÃ­o. \"NÂº Subdimensiones\" debe ser un nÃºmero mayor que 0 y \"NÂº de Valores\" mayor o igual que 2';
	$string['AAttribute'] = 'Este campo no puede estar vacÃ­o. Por favor, especifique un nÃºmero mayor que 0';
	$string['ADiferencial'] = '\"NÂº de Atributos\" debe ser mayor que 0. \"NÂº de Valores\" debe ser IMPAR';
	$string['ErrorFormato'] = 'El fichero estÃ¡ vacÃ­o o el formato es incorrecto';
	$string['ErrorAcceso'] = 'No se pudo acceder al instrumento';
	$string['ErrorExtension'] = 'Formato Incorrecto. La extensiÃ³n debe ser \"evx\"';
	...
	$string['TAumentar'] = 'Aumentar tamaÃ±o de fuente';
	$string['TDisminuir'] = 'Disminuir tamaÃ±o de fuente';
