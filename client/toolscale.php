<?php
	/**
		Representa una escala de valoraci贸n
	*/
	class toolscale{
		//string
		private $titulo;
		...
		//array -- n煤mero de dimensiones de cada dimensi贸n
		private $numdim;
		
		//array -- titulo de cada subdimensi贸n de cada dimensi贸n
		private $subdimension;
		
		//array -- n煤mero de subdimensiones de cada subdimensi贸n
		private $numsubdim;
		
		//array -- titulo de cada atributo de cada subdimensi贸n de cada dimensi贸n
		private $atributo;
		
		//array -- n煤mero de atributos de cada subdimensi贸n
		private $numatr;
		
		//array -- valores de cada dimensi贸n
		private $valores;
		
		//array -- n煤mero de valores de cada dimensi贸n
		private $numvalores;
		
		//boolean -- indica si el instrumento tiene activada la valoraci贸n total
		private $valtotal;
		
		//integer -- n煤mero de grados de la valoraci贸n total
		private $numtotal;
		
		//array -- grados de la valoraci贸n total
		private $valorestotal;
		
		//integer -- porcentaje de la valoraci贸n total
		private $valtotalpor;
		
		//array -- indica si est谩 activada la valoraci贸n global por cada dimensi贸n
		private $valglobal;
		
		//array -- porcentaje de la valoraci贸n global de cada dimensi贸n
		...
		//En caso de formar parte de un instrumento mixto, almacenar谩 el valor porcentaje
		private $porcentage;
		
		//string -- comentarios
		private $observation;
		
		//'view' | 'design' -- indica si el instrumento est谩 en modo dise帽o o vista previa
		private $view;
		...
		//Array -- Almacena los comentarios de los atributos otorgados durante el proceso de evaluaci髇
		private $valuecommentAtr;
		
		//Array -- Almacena los comentarios de las dimensiones otorgados durante el proceso de evaluaci髇
		private $valuecommentDim;
		//TODO --- A馻dir $atrScore $globalScore $totalScore
		...
		function display_header(){
			...
			<html>
				<head>
					...
					<script type="text/javascript" src="javascript/tama帽o.js"></script>
				...
				<body id="body" >
					<div id="cabecera">
						<div id="menu">				
							...
							<a onClick="MasTxt(\'tool\');" href=#><img id="aumentar" src="images/aumentar.png" alt="Aumentar" title="Aumentar tama帽o de fuente" onmouseover="javascript:cAmbiaOver(this.id, \'images/aumentarhover.png\');" onmouseout="javascript:cAmbiaOut(this.id, \'images/aumentar.png\');"/></a>
							<a onClick="MenosTxt(\'tool\');" href=#><img id="disminuir" src="images/disminuir.png" alt="Disminuir" title="Disminuir tama帽o de fuente" onmouseover="javascript:cAmbiaOver(this.id, \'images/disminuirhover.png\');" onmouseout="javascript:cAmbiaOut(this.id, \'images/disminuir.png\');"/></a>
...
//----------------------------------------------
		...
		/*
		@param $array 
		@param $i 铆ndice del elemento a eliminar en $array
		...
		*/
		...
		@param $i 铆ndice del elemento a partir del que introducir谩 el elemento $elem en $array
		@param $elem nuevo elemento a a帽adir
		@param $index indice del nuevo elemento. Si no se especifica, el nuevo 铆ndice ser谩 $i+1
		@return $array con el nuevo elemento
		A帽ade $elem a @array a continuaci贸n de $i.
		*/
